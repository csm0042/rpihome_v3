...
# Define test class ***********************************************************
class TestGDSACKmessage(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.temp_str = str()
        self.temp_str2 = str()
        super(TestGDSACKmessage, self).__init__(*args, **kwargs)


    def setUp(self):
        self.message = GDSACKmessage(log=self.log)
        super(TestGDSACKmessage, self).setUp()
