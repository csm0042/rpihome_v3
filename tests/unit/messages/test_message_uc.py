...
# Define test class ***********************************************************
class TestUCmessage(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.temp_str = str()
        self.temp_str2 = str()
        super(TestUCmessage, self).__init__(*args, **kwargs)


    def setUp(self):
        self.message = UCmessage(log=self.log)
        super(TestUCmessage, self).setUp()
